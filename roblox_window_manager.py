...
def wait_for_image(image_path, timeout=300, confidence=0.9):
...
def choose():
    ...
    order = ['health3.png','health2.png','health1.png',"buff3.png","buff2.png","buff1.png","tradeoff1.png","tradeoff2.png","tradeoff3.png"]
